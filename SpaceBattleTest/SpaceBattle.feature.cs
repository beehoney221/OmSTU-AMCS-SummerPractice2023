...
namespace SpaceBattleTest
{
    ...
    public partial class НахождениеКоординатКорабляПослеДвиженияFeature : object, Xunit.IClassFixture<НахождениеКоординатКорабляПослеДвиженияFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public НахождениеКоординатКорабляПослеДвиженияFeature(НахождениеКоординатКорабляПослеДвиженияFeature.FixtureData fixtureData, SpaceBattleTest_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "", "Нахождение координат корабля после движения", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("FeatureTitle", "Нахождение координат корабля после движения")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                НахождениеКоординатКорабляПослеДвиженияFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                НахождениеКоординатКорабляПослеДвиженияFeature.FeatureTearDown();
            }
        }
    }
}
